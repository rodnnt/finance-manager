...
<div class="container my-4">
    ...
    <form action='/coins/update/{{$coin->id}}' method='post'>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" name="code" id="code" value='{{$coin->code}}' 
                placeholder="Informe o código da moeda" required>
        </div>

        <div class="form-group mb-3">
            <label for="name" class="form-label fs-6 fs-md-5 fs-lg-4">Nome da Moeda:</label>
            <input type="text" class="form-control" name="name" id="name" value='{{$coin->name}}' 
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" name="symbol" id="symbol" value='{{$coin->symbol}}' 
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" name="created_at" id="created_at" value='{{$coin->created_at}}' disabled>
        </div>

        <div class="form-group mb-3">
            <label for="updated_at" class="form-label fs-6 fs-md-5 fs-lg-4">Última Atualização:</label>
            <input type="text" class="form-control" name="updated_at" id="updated_at" value='{{$coin->updated_at}}' disabled>
        </div>
        ...
        <div class="form-group d-flex justify-content-between mt-4">
            ...
            <a href='/coins' class="btn btn-outline-danger">Cancelar</a>
        </div>
